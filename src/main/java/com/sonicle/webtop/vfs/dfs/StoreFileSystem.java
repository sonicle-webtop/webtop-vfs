 ...
 */
package com.sonicle.webtop.vfs.dfs;
...
public abstract class StoreFileSystem {
	...
	public StoreFileSystem(String uri, String parameters) {
		this(uri, parameters, false);
	}
	
	public StoreFileSystem(String uri, String parameters, boolean autoCreateRoot) {
		this.uri = uri;
	...
	private void initRootFileObject() throws FileSystemException {
		...
		FileObject fo = fsm.resolveFile(uri, fso);
